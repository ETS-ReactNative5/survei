...
class TransactionPending extends Page {
	...
	handleSubmitUpload = () => {
		...
		if (uploadedImageData) {
			this.props.history.push('/learning-path/uuid/confirmed', { imageURL: URL.createObjectURL(uploadedImageData) });
		} else {
					...
					<div className="transaction-payment-inner">
						<div className="transaction-section-subtitle center-align">Segera Lakukan Pembayaran</div>
							...
							<div className="content-text-wrapper">
								<span className="content-text strong">Rp172.<span className="font-red">022</span></span>
