...
import { API_UJIAN_PRAKTEK } from "../Util";
import FontAwesome from "react-fontawesome";


class ShareToEmailUjianPrakteModal extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
			formData: {
	...
	handleSubmitForm = e => {
		e.preventDefault();
		const api_url = API_UJIAN_PRAKTEK + this.state.uuid + "/send";
...
export default ShareToEmailUjianPrakteModal;
