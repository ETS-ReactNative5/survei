...
class NewCertificate extends CourseRecap {
	constructor(props) {
		super(props);
	}
		...
		return (
			<div>
				<div className="container-medium">
					<div className="bg-white pad-m bg-certificate-new shadowed">
                        <div className="certificate-student-number-new">
